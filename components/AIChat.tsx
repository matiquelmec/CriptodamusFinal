...
const AIChat: React.FC<AIChatProps> = ({ selectedSymbol }) => {
  ...
  useEffect(() => {
    ...
    setMessages([{
      ...
      role: 'model',
      content: `### 🤖 Asesor Autónomo Institucional (Tier-1)\n\n**Activo Seleccionado:** ${selectedSymbol}\n\n**Capacidades Institucionales:**\n- 🎯 **SMC (Smart Money Concepts)**: Barridos de liquidez, Order Blocks y Fair Value Gaps\n- 💎 **Validación Fractal**: Multi-timeframe (1H + 4H + 1D + 1W) para máxima precisión\n- 💥 **Detección de Liquidaciones**: Identifica cascadas de liquidaciones y oportunidades contrarian\n- 📊 **Volume Profile Completo**: Análisis de zonas de descuento/premium institucional\n- 🔥 **Squeeze Direccional**: Predice dirección de breakout con validación de volumen\n- 🌍 **Contexto Macro**: Integración de BTC Dominance, USDT.D y régimen de mercado\n\n**Detección Automática:**\nEl sistema detecta el régimen de mercado (TRENDING, RANGING, VOLATILE, EXTREME) y ajusta el análisis según condiciones macro en tiempo real.\n\n**Para comenzar:** Haz clic en **Enviar** para generar un análisis integral con plan DCA institucional de 3 niveles.`,
      timestamp: Date.now(),
      isThinking: false
    }]);
