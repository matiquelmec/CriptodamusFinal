import { calculateFractals, calculateAutoFibs, calculateEMA } from './services/mathUtils';

// Mock Data: Uptrend with a clear pullback
// Prices go from 100 -> 200 -> 150 (Retracement) -> 250
const highs = [];
const lows = [];
const closes = [];
...
console.log("Last Fractal High:", fractalHighs[fractalHighs.length - 1]);
...
console.log("Golden Pocket Low (0.65):", fibs.level0_65);
console.log("Deep (0.886):", fibs.level0_886);
