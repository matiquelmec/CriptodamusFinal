...
export function calculateDCAPlan(
    ...
    // If our Average Entry (WAP) is very far from current Price, this is "Chasing" or "Pre-emptive".
    // A professional trader wants entries within a reasonable volatility range.
