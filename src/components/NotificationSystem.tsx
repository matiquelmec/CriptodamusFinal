  ...
  return (
    <div className="fixed top-4 right-4 z-[100] flex flex-col gap-3 max-w-sm w-full pointer-events-none">
      {notifications.map((n) => (
        <div
          key={n.id}
          className={`pointer-events-auto rounded-xl border p-4 shadow-2xl backdrop-blur-md animate-in slide-in-from-right duration-300 flex items-start gap-3 relative ${n.type === 'success' ? 'bg-success/10 border-success/30 text-success' :
