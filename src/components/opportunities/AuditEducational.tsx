...
const AuditEducational: React.FC<AuditEducationalProps> = ({ onClose }) => {
    return (
        <div className="fixed inset-0 bg-[#06080a]/90 backdrop-blur-md z-[9999] flex items-center justify-center p-4 animate-in fade-in duration-300">
            <div className="bg-[#0b0e14] border border-white/10 rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-300">
                {/* Header */}
